...
namespace ECommerceCart.Controllers
{
    public class CartController : Controller
    {
        private static List<Product> _products = new List<Product>
        {
            ...
            new Product { Id = 3, Name = "Tablet", Price = 300, Description = "Portable tablet with touchscreen" },
            new Product { Id = 4, Name = "Ipad", Price = 800, Description = "Ipad with high resolution" }
        };
